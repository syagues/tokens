...
import com.forkstone.tokens.gameworld.GameRenderer;
import com.forkstone.tokens.gameworld.GameWorld;
import com.forkstone.tokens.helpers.AssetLoader;
import com.forkstone.tokens.helpers.InputHandler;
...
public class GameScreen implements Screen {
    ...
    public GameScreen(ButtonsGame game, ActionResolver actionResolver, int level) {
        Gdx.app.log("GameScreen", "Attached");
        Gdx.app.log("GameWidth " + gameWidth, "GameHeight " + gameHeight);
        world = new GameWorld(game, actionResolver, gameWidth, gameHeight, worldWidth, worldHeight, level);
