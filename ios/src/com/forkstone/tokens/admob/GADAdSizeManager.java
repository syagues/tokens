...
public final class GADAdSizeManager extends NSObject {
    ...
    public static native @ByVal GADAdSize getGADAdSize (@ByVal CGSize size);
    ...
    public static native @ByVal GADAdSize getFullWidthPortrait (float height);
    ...
    public static native @ByVal GADAdSize getFullWidthLandscape (float height);
    ...
    public static native @ByVal CGSize getCGSize (@ByVal GADAdSize size);
